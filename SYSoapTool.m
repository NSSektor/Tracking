...
- (void)connectionDidFinishLoading:(NSURLConnection *)connection
{
	...
	if(connection == theConnection)
	{
        ...
        /*
         NSData* tmp_Data = [tmp dataUsingEncoding: NSASCIIStringEncoding];
         
         NSString* newStr = [[NSString alloc] initWithData:tmp_Data
         encoding:NSISOLatin1StringEncoding];
         char converted[([newStr length] + 1)];
         [newStr getCString:converted maxLength:([newStr length] + 1) encoding: NSISOLatin1StringEncoding];
         NSLog(@"%s", converted);
         newStr = [NSString stringWithCString:converted encoding:NSISOLatin1StringEncoding];*/
        ...
        /*
         ...
         parser = [[SYXmlParser alloc]initWithData:data];
